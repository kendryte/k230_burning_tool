...
PUBLIC on_usb_connect_t kburnOnUsbConnect(KBCTX scope, on_usb_connect verify_callback, void *ctx);

PUBLIC on_usb_bootrom_handle_t kburnOnUsbBootromHanshake(KBCTX scope, on_usb_bootrom_handle rom_callback, void *ctx);

PUBLIC on_usb_loader_handle_t kburnOnUsbUbootHandshake(KBCTX scope, on_usb_loader_handle load_callback, void *ctx);
